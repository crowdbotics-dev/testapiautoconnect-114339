...
## Project Structure
    ...
    ├── testapiautoconnect_114339  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_114339`
...
2. Clone this repo and `cd testapiautoconnect_114339`
